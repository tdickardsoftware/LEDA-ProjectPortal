...
export default function TeamPageContent({teamData, memberDetails} : {teamData: Team, memberDetails: {fullName: string | undefined, ledaId: string, isCaptain: boolean}[]}) {
    ...
    return (
        <div className="container mx-auto p-6">
            ...
            {editValues && (
                <TeamEditForm rowData={teamData} onRefresh={handleRefresh} onClose={handleEdit} handleRefresh={handleRefresh}/>
            )}
		</div>
    );
}