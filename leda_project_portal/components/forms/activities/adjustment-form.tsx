...
export default function AdjustmentForm({
    ...
    global: boolean;
    teamId: string;
    handleAdjustment: (teamId: string, amount: number, type: boolean, notes: string | undefined, global: boolean) => void;
	...
	async function onSubmit(values: z.infer<typeof adjustmentFormSchema>) {
        ...
        handleAdjustment(teamId, formattedAmount, values.type, values.notes, global);
        setOpen(false)
	}
		...
		<Form {...form}>
			...
			>
                                    ...
                                    <FormControl>
                                        ...
                                        >
                                            ...
                                            <SelectContent className="bg-white">
                                                ...
                                                <SelectItem value="false">Debit</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </FormControl>
                                    <FormMessage />
				...
				<div className="flex justify-center">
                    <Button type="submit">
                        {global ? "Save Global Adjustment" : "Save Team Adjustment"}
                    </Button>
				</div>
			</form>
		</Form>
