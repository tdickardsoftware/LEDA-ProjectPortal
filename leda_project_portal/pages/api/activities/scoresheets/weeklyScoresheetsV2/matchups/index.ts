...
const log = createRouteLogger("/api/activities/scoresheets/weeklyScoresheetsV2/matchups");
...
export default async function handler(
	...
	// Handle GET requests
	if (req.method === "GET") {
		log.info({ method: "GET", query: req.query }, "Fetch weekly scoresheets matchups");
		try {
